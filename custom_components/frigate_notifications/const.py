...
REVIEW_HISTORY_MAX_REVIEWS = 10
REVIEW_HISTORY_MAX_STEPS = 40
LAST_SENT_RECENT_LIMIT = 10
LAST_SENT_TEXT_LIMIT = 200

OPTION_KEEP_REVIEW_HISTORY = "keep_review_history"
